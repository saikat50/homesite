...
<main id="spareroom" class="wrap">
    ...
    <div class="grid-4-8-4 " id="mainheader"><div>&nbsp;</div><div><h1>Advertise your whole property</h1></div><div>&nbsp;</div></div>
    ...
    <div class="grid-4-8-4">
        ...
        <aside>
            <div id="testimonials">
                <blockquote class="testimonial"><p>...found a fantastic place last night through your site, all in one day... am so grateful !!</p><footer><cite>K Dunn</cite></footer></blockquote>              </div>
        </aside>

        <div id="maincontent">


            <link href="https://assets.spareroom.co.uk/assets/819ff64b22867da452551f37edcc64eb.css" rel="stylesheet" type="text/css" media="screen">
            <div class="listing_options">

                <p>
                    Want to rent your property out to a group of sharers, but don't want to get into dealing with individual room contracts - advertise your property as a whole on SpareRoom and give suggested room prices to help the group divvy up the rent.
                    ...
                    <div class="block block_free">
                        ...
                        <div class="block_content">
                            <ul class="bulletlist points">
                                ...
                                <li>Simultaneous listing on FindaFlat.com</li>
...
<img src="//assets.spareroom.co.uk/img/spareroom/v4/icons/early_bird.svg?v=1" class="svg early_bird_icon " alt="Early bird">Early Bird Access</span>&nbsp;<i class="fas fa-info-circle"></i><span class="tooltip_box"><span class="tooltip_text">Early Bird Access is just one benefit of upgrading. With it you can contact all ads on the site as soon as they appear - otherwise you'll have to wait 7 days before you can contact any ads with the Early Bird icon. <a href="/content/infowebsitehelp/how-the-site-works" title="About Early Bird Access">Find out more &raquo;</a></span><span class="tooltip_arrow">&nbsp;</span></span><span class="tooltip_background" tabindex="-1"></span></span>						</b>
                                    so you can contact all Room Wanted advertisers
                                </li>
                            </ul>

                            <p class="place_an_ad_now"><a class="button" href="/flatshare/find-postcode3.pl?desc=Bold+Advert&amp;amount=10&amp;scp=Y">Post an ad now</a>				</p>
                        </div>
                    </div>
                </div>
                <section>
                    ...
                    <ul class="bulletlist pricelist">
                        <li>1 week: <strong>&pound;10.99</strong></li>
                        <li>2 weeks: <strong>&pound;21.99</strong></li>
                        <li>4 weeks: <strong>&pound;24.99</strong></li>
                        <li>6 months: <strong>&pound;99</strong></li>
                    </ul>

                    <blockquote>
                        <p class="quote">
                            I found your service EXCEPTIONAL !  Once I upgraded to Bold....steady interest resulted, and the room was soon let.
                        </p>
                        <p class="author">
                            Andrew Beecroft
                        </p>
...
<img src="//assets.spareroom.co.uk/img/spareroom/v4/icons/early_bird.svg?v=1" class="svg early_bird_icon " alt="Early bird">Early Bird</span>&nbsp;<i class="fas fa-info-circle"></i><span class="tooltip_box"><span class="tooltip_text">Early Bird Access is just one benefit of upgrading. With it you can contact all ads on the site as soon as they appear - otherwise you'll have to wait 7 days before you can contact any ads with the Early Bird icon. <a href="/content/infowebsitehelp/how-the-site-works" title="About Early Bird Access">Find out more &raquo;</a></span><span class="tooltip_arrow">&nbsp;</span></span><span class="tooltip_background" tabindex="-1"></span></span></span><span class="earlyBird status mobile">Early Bird</span><span class="tooltip example-save-button" tabindex="-1"><span class="tooltip_item"><span class="anchor_text"><i class="far fa-star"></i><span> Save</span></span><span class="tooltip_box"><span class="tooltip_text">Add this to your 'saved ads' list for quick reference in future. You'll find your saved ad lists under the 'search' tab in the main menu</span><span class="tooltip_arrow">&nbsp;</span></span></span><span class="tooltip_background" tabindex="-1"></span></span><span  class="more desktop">More info</span></footer>
                    ...
                    <blockquote>
                        <p class="quote">
                            I would like to say how good your site is we have let 12 rooms to very
                            good professionals and its all thanks to your web site spareroom.co.uk
                            As an agent  it is a great and easy site to use. Thank you Martin & Co
                            Bristol
                        </p>
                        <p class="author">
                            Martin & Co Bristol
